...
class CoachFutureTile extends StatelessWidget {
  final String userID;
  final String questionType;

  const CoachFutureTile({
    Key? key,
  ...
  Widget build(BuildContext context) {
    final completedText = context.watch<CoachFutureProvider>().completedText;
    final isLoading = context.watch<CoachFutureProvider>().isLoading;
