...
class StudentFeedbackOCTile extends StatelessWidget {
  final String questionType;

  const StudentFeedbackOCTile({
    Key? key,
  ...
  Widget build(BuildContext context) {
    final completedText =
        context.watch<StudentFeedbackOCProvider>().completedText;
    final isLoading = context.watch<StudentFeedbackOCProvider>().isLoading;
