...
class StudentFeedbackSITile extends StatelessWidget {
  final String questionType;

  const StudentFeedbackSITile({
    Key? key,
  ...
  Widget build(BuildContext context) {
    final completedText =
        context.watch<StudentFeedbackSIProvider>().completedText;
    final isLoading = context.watch<StudentFeedbackSIProvider>().isLoading;
